...
//  DUPME
//
//  Created by Hossein on 13/12/2016.
...
class LoginController: UIViewController {
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 39/255, green: 89/255, blue: 41/255, alpha: 1)
    ...
    func handleRegister(){
        ...
        FIRAuth.auth()?.createUser(withEmail: email, password: password, completion: { (user: FIRUser?, error) in
            ...
            let ref = FIRDatabase.database().reference(fromURL: "https://dupme-2692d.firebaseio.com/")
